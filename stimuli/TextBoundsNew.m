...
% bounds=TextBoundsNew(window, string [, yPositionIsBaseline=0])
% *this is a copy of TextBounds from newer version of PTB, which includes
% the yPositionIsBaseline argument. For use on computers without that
% updated TextBounds
% 
